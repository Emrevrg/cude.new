...
echo "Starting Cude.new update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/cude-new/cude.new/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
