 ...
 *
 * ```html
 * <cude_file_modifications>
 * <diff path="/home/project/index.js">
 * - console.log('Hello, World!');
 * + console.log('Hello, Cude!');
 * </diff>
 * </cude_file_modifications>
 * ```
 */
