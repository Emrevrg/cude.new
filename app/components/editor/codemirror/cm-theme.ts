// Cude.new - cm-theme.ts (Cude product surface, 2026)
...
function getEditorTheme(settings: EditorSettings) {
  return EditorView.theme({
    ...
    '.cm-tooltip.cm-readonly-tooltip': {
      padding: '4px',
      whiteSpace: 'nowrap',
      backgroundColor: 'var(--cude-bg-depth-2)',
      borderColor: 'var(--cude-borderColorActive)',
      '& .cm-tooltip-arrow:before': {
        borderTopColor: 'var(--cude-borderColorActive)',
      },
