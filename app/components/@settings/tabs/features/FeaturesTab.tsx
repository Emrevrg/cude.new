/*
 * Cude.new - FeaturesTab.tsx (Cude product surface, 2026)
...
import { listPrompts } from '~/lib/cude/prompt';
      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={classNames(feature.icon, 'w-5 h-5 text-cude-textSecondary')} />
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-cude-textPrimary">{feature.title}</h4>
              {feature.beta && (
        ...
        <p className="mt-2 text-sm text-cude-textSecondary">{feature.description}</p>
        {feature.tooltip && <p className="mt-1 text-xs text-cude-textTertiary">{feature.tooltip}</p>}
      </div>
    </motion.div>
  ),
);
...
const FeatureSection = memo(
  ({
    ...
    >
      <div className="flex items-center gap-3">
        <div className={classNames(icon, 'text-xl text-gray-500')} />
        <div>
          <h3 className="text-lg font-medium text-cude-textPrimary">{title}</h3>
          <p className="text-sm text-cude-textSecondary">{description}</p>
        </div>
      </div>
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-medium text-cude-textPrimary group-hover:text-gray-500 transition-colors">
              Prompt Library
            </h4>
