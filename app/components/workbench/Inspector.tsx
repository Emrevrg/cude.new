// Cude.new - Inspector.tsx (Cude product surface, 2026)
  ...
  return (
    <>
      {isActive && hoveredElement && (
        ...
        >
          <div className="absolute -top-8 left-0 bg-cude-background-depth-1 border border-cude-borderColor text-cude-textPrimary text-xs px-2 py-1 rounded whitespace-nowrap shadow-sm">
