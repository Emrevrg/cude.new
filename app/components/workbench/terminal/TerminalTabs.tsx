// Cude.new - TerminalTabs.tsx (Cude product surface, 2026)
  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-cude-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-cude-background-depth-2 border-y border-cude-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-cude-terminals-buttonBackground text-cude-textSecondary hover:text-cude-textPrimary':
                            isActive,
                          'bg-cude-background-depth-2 text-cude-textSecondary hover:bg-cude-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-cude-terminals-buttonBackground text-cude-textPrimary': isActive,
                            'bg-cude-background-depth-2 text-cude-textSecondary hover:bg-cude-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-cude-textTertiary hover:text-cude-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            {terminalCount < MAX_TERMINALS && (
              <IconButton icon="i-ph:plus" size="md" onClick={addTerminal} title="New terminal" />
            )}
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachCudeTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting cude terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachCudeTerminal(terminal)}
