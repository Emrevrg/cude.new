// Cude.new - ScreenshotSelector.tsx (Cude product surface, 2026)
    ...
    const handleCopySelection = useCallback(async () => {
      ...
      try {
        ...
        reader.onload = (e) => {
          ...
          if (textarea) {
            const setUploadedFiles = (window as any).__CUDE_SET_UPLOADED_FILES__;
            const setImageDataList = (window as any).__CUDE_SET_IMAGE_DATA_LIST__;
            const uploadedFiles = (window as any).__CUDE_UPLOADED_FILES__ || [];
            const imageDataList = (window as any).__CUDE_IMAGE_DATA_LIST__ || [];
