// Cude.new - GitHubDeploy.client.tsx (Cude product surface, 2026)
...
export function useGitHubDeploy() {
  ...
  const handleGitHubDeploy = async () => {
    const connection = readStored<Record<string, any>>('github_connection');
  ...
  return {
    isDeploying,
    handleGitHubDeploy,
    isConnected: !!readStored<Record<string, any>>('github_connection')?.user,
  };
}
