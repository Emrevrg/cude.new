// Cude.new - MCPTools.tsx (Cude product surface, 2026)
      ...
      <div className="flex">
        ...
        >
          {!isInitialized ? (
            ...
            <div className="i-cude:mcp text-xl"></div>
          )}
        </IconButton>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {serverEntries.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-cude-textSecondary">
                ...
                <div>{error && <p className="mt-2 text-sm text-cude-icon-error">{error}</p>}</div>
              </div>
