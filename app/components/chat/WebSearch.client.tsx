// Cude.new - WebSearch.client.tsx (Cude product surface, 2026)
...
export function WebSearch({ onSearchResult, disabled = false }: WebSearchProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        {isSearching ? (
          <div className="i-svg-spinners:90-ring-with-bg text-cude-loader-progress text-xl animate-spin" />
        ) : (
      ...
      {isOpen && (
        <div
          className={classNames(
            ...
            'rounded-lg border border-cude-borderColor bg-cude-background-depth-2 p-2 shadow-lg',
          )}
        >
          <input
            ref={inputRef}
