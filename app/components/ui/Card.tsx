// Cude.new - Card.tsx (Cude product surface, 2026)
  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-cude-borderColor bg-cude-background-depth-1 text-cude-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-cude-textSecondary', className)} {...props} />;
  },
);
