// Cude.new - GradientCard.tsx (Cude product surface, 2026)
  ...
  return (
    <motion.div
      className={classNames(
        ...
        gradientClass,
        borderEffect ? 'border border-cude-borderColor dark:border-cude-borderColor-dark hover:border-gray-500/40' : '',
