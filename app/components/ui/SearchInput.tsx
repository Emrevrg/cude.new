// Cude.new - SearchInput.tsx (Cude product surface, 2026)
  ...
  (
    ...
    return (
      <div className={classNames('relative flex items-center w-full', containerClassName)}>
        ...
        <div className={classNames('absolute left-3 top-1/2 -translate-y-1/2 text-cude-textTertiary', iconClassName)}>
          {loading ? (
        ...
        <AnimatePresence>
          {hasValue && showClearButton && (
            <motion.button
              ...
              type="button"
              onClick={onClear}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-cude-textTertiary hover:text-cude-textSecondary p-1 rounded-full hover:bg-cude-background-depth-2"
