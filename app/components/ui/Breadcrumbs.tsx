// Cude.new - Breadcrumbs.tsx (Cude product surface, 2026)
      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-cude-textPrimary dark:text-cude-textPrimary-dark'
              : 'text-cude-textSecondary dark:text-cude-textSecondary-dark hover:text-cude-textPrimary dark:hover:text-cude-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-cude-textTertiary dark:text-cude-textTertiary-dark',
                  )}
                />
              )}
            </li>
