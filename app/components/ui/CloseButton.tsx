// Cude.new - CloseButton.tsx (Cude product surface, 2026)
  ...
  return (
    <motion.button
      ...
      className={classNames(
        'text-cude-textTertiary hover:text-cude-textSecondary dark:text-cude-textTertiary-dark dark:hover:text-cude-textSecondary-dark',
        'rounded-lg hover:bg-cude-background-depth-2 dark:hover:bg-cude-background-depth-3',
