...
Cude.new allows you to choose the LLM that you use for each prompt! Currently, you can use models from 19 providers including OpenAI, Anthropic, Ollama, OpenRouter, Google/Gemini, LMStudio, Mistral, xAI, HuggingFace, DeepSeek, Groq, Cohere, Together AI, Perplexity AI, Hyperbolic, Moonshot AI (Kimi), Amazon Bedrock, GitHub Models, Amazon Bedrock, and more - with easy extensibility to add any other model supported by the Vercel AI SDK! See the instructions below for running this locally and extending it to include more models.
...
[Join the discussions!](https://github.com/cude-new/cude.new/discussions)

The [documentation](https://github.com/cude-new/cude.new) covers running and deploying Cude.new yourself.
...
Alternatively, you can download the latest version of the project directly from the [Releases Page](https://github.com/your-org/cude.new/releases/latest). Simply download the .zip file, extract it, and proceed with the setup instructions below. If you are comfortable using git then run the command below.

Clone the repository using Git:

```bash
git clone https://github.com/your-org/cude.new
cd cude.new
```
...
There are two ways to configure your API keys in Cude.new:
...
- On **Mac**, you can find the file at `[your name]/Cude.new/.env.example`.
...
1. **Build the Docker Image**:
   ...
   ```bash
   docker build . --target cude:development
   ```
...
To keep your local version of Cude.new up to date with the latest changes, follow these steps for your operating system:
...
This ensures that you're running the latest version of Cude.new and can take advantage of all the newest features and bug fixes.

---

## Adding New LLMs

Cude.new supports a modular architecture for adding new LLM providers and models. The system is designed to be easily extensible while maintaining consistency across all providers.
...
Cude.new supports MCP (Model Context Protocol) servers to extend AI capabilities with external tools and services. MCP allows you to connect various tools and services that the AI can use during conversations.
...
Cude.new provides comprehensive Git integration for version control, collaboration, and project management.
...
Cude.new provides one-click deployment to popular hosting platforms, making it easy to share your projects with the world.
...
3. Cude.new automatically builds and deploys your project
...
Cude.new integrates with Supabase to provide backend database functionality, authentication, and real-time features for your applications.

### Setting up Supabase

1. Create a Supabase project at [supabase.com](https://supabase.com)
2. Get your project URL and API keys from the Supabase dashboard
3. Configure the connection in your Cude.new project
...
Cude.new uses WebContainer technology to provide a secure, isolated development environment with live preview capabilities.
...
Cude.new comes with a comprehensive collection of starter templates to help you quickly bootstrap your projects. Choose from popular frameworks and technologies:
...
1. Start a new project in Cude.new
...
Cude.new includes a convenient help icon (?) in the sidebar that provides quick access to comprehensive documentation. Simply click the help icon to open the full documentation in a new tab.
...
- **Discussions**: [github.com/cude-new/cude.new/discussions](https://github.com/cude-new/cude.new/discussions)
- **Contributing Guide**: Learn how to contribute to the project

## Tips and Tricks

Here are some tips to get the most out of Cude.new:

- **Be specific about your stack**: If you want to use specific frameworks or libraries (like Astro, Tailwind, ShadCN, or any other popular JavaScript framework), mention them in your initial prompt to ensure Cude.new scaffolds the project accordingly.
- **Use the enhance prompt icon**: Before sending your prompt, try clicking the 'enhance' icon to have the AI model help you refine your prompt, then edit the results before submitting.
- **Scaffold the basics first, then add features**: Make sure the basic structure of your application is in place before diving into more advanced functionality. This helps Cude.new understand the foundation of your project and ensure everything is wired up right before building out more advanced functionality.
- **Batch simple instructions**: Save time by combining simple instructions into one message. For example, you can ask Cude.new to change the color scheme, add mobile responsiveness, and restart the dev server, all in one go saving you time and reducing API credit consumption significantly.
- **Access documentation quickly**: The docs cover guides, troubleshooting, and best practices.
