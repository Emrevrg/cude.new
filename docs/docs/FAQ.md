...
??? question "What are the best models for Cude.new?"
For the best experience with Cude.new, we recommend using the following models from our 19 supported providers:
...
Cude.new uses a modular provider architecture. To add a new provider:
...
Cude.new provides multiple ways to access help and documentation:
...
??? question "How do I get the best results with Cude.new?"
...
MCP extends Cude.new's AI capabilities with external tools:
...
??? question "How do I deploy my Cude.new projects?"
Cude.new supports one-click deployment to multiple platforms:
...
Cude.new provides comprehensive Git and GitHub integration:
...
??? question "How do I contribute to Cude.new?"
Check out our [Contribution Guide](CONTRIBUTING.md) for more details on how to get involved!

??? question "What are the future plans for Cude.new?"
Visit our [Roadmap](https://roadmap.sh/r/ottodev-roadmap-2ovzo) for the latest updates.  
 New features and improvements are on the way!

??? question "Why are there so many open issues/pull requests?"
Cude.new began as a small showcase project on @ColeMedin's YouTube channel to explore editing open-source projects with local LLMs. However, it quickly grew into a massive community effort!

    We're forming a team of maintainers to manage demand and streamline issue resolution. The maintainers are rockstars, and we're also exploring partnerships to help the project thrive.

## New Features & Technologies

??? question "What's new in Cude.new?"
Recent major additions to Cude.new include:
...
Cude.new offers templates for popular frameworks and technologies:
...
??? question "How do local LLMs compare to larger models like Claude 3.5 Sonnet for Cude.new?"
...
If you're having trouble with MCP integrations:
    ...
    - **Test server connectivity** outside of Cude.new
...
**Windows development environment**: Install Visual Studio C++ (version 14.40.33816 or later). More details in [GitHub Issues](https://github.com/cude-new/cude.new/issues/19)
...
[Open a discussion](https://github.com/cude-new/cude.new/discussions){target=\_blank} for questions and help

!!! bug "Report Issues"
[Open an Issue](https://github.com/cude-new/cude.new/issues/19){target=\_blank} in our GitHub Repository
